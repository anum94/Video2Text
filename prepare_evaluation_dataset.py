...
if __name__ == '__main__':
    ...
    instructions = [
        ...
        f"\nInside each folder you will find a video clip from a game and {len(model_dict.keys())} subfolders, each containg the commentaries generated by a model."
        f"\nEach model generated commentary using 2 methods, so in total you would have {len(model_dict.keys()) *2} commentaries"
