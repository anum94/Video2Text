...
def get_user_prompt(mode="baseline"):
    if mode == "baseline":
        ...
        user_prompt = (
            "You are a professional commentator for car racing games. You will be provided with a short video interval from a"
            "complete race along with the partial commentary which summarizes the happening of the game before the provided"
            "video interval. As you might know, sometimes commentators stay silent for a few seconds during the game."
